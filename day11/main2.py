...
def main():
    ...
    test_state = State(4, [4, 1, 4, 4], 1)
    print(initial_state.hash() == test_state.hash())
    print(initial_state.hash())
    print(test_state.hash())
    ...
    while node_queue:
        ...
        #visited_states.append(parent_node.state.hash())
        print(len(unwind_path(parent_node)))
        print(len(node_queue), flush=True)
